...
public class ReplaceMethodNameMutator {
public enum ReplaceMethodNameMutator1 implements MethodMutatorFactory {
...
class ReplaceMethodName extends MethodVisitor {
    ...
    private void scanMethodName(int opcode, String owner, String name, String desc, boolean itf) {
        ...
        //System.out.println(byteSource.get(owner) + "XXXXXXXXXXXXXXXXXXXXXXXXXX");
        //Optional<byte[]> bytes = this.byteSource.get(owner);
